      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3">
            <div class="panel panel-success">
              <div class="panel-heading">
                <h4 class="text-center">Code et Examen theorique</h4>
              </div>
              ...
              <ul class="list-group list-group-flush text-center">
                ...
                <li class="list-group-item"> Livre de code <span class="fa fa-check pull-right"></span></li>
              </ul>
              <div class="panel-footer"><a type="button" class="btn btn-lg btn-block btn-success"
                  data-toggle="modal" data-target=".modal-lg-1" href="#">Detail</a></div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="panel panel-warning">
              ...
              <div class="panel-body text-center">
                ...
                <p class="sublead">( Pour 20 seance minimum )</p>
              </div>
              <ul class="list-group list-group-flush text-center">
                <li class="list-group-item"> Pass-Rousseau <span class="fa fa-check pull-right"></span></li>
                <li class="list-group-item"> Ligne support <span class="fa fa-check pull-right"></span></li>
                <li class="list-group-item"> Cahier de code <span class="fa fa-check pull-right"></span></li>
              </ul>
              <div class="panel-footer"><a type="button" class="btn btn-lg btn-block btn-warning"
                  data-toggle="modal" data-target=".modal-lg-2" href="#">Detail</a></div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="panel panel-warning">
              ...
              <div class="panel-footer"> <a type="button" class="btn btn-lg btn-block btn-warning"
                  data-toggle="modal" data-target=".modal-lg-3" href="#">Detail</a>
              </div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="panel panel-info">
              ...
              <div class="panel-body text-center">
                <p class="lead"> <strong>900 €</strong></p>
                <p class="sublead"> ( Info a donner ici ) </p>
                ush text-center"&gt;
                ...
                <div class="panel-footer"><a type="button" class="btn btn-lg btn-block btn-info"
                    data-toggle="modal" data-target=".modal-lg-4" href="#">Detail</a></div>
              </div>
            </div>
          </div>
          <div class="row">
          ...
          <div class="row text-center">
            <div class="col-md-4"> <span><i class="fa fa-euro fa-4x"></i></span>
              <h3>Permis à 1€</h3>
              Le permis a 1€ est disponible a l'auto-ecole .<br>
              <p>Pour plus d'informations référer vous à notre <a href="#">article</a>
              </p>
            </div>
            <div class="col-md-4"> <span><i class="fa fa-credit-card fa-4x">&nbsp;</i><i
                  class="fa fa-cc-visa fa-4x">&nbsp;</i><i class="fa fa-cc-mastercard fa-4x"></i></span>
              <h3>Carte de crédit</h3>
              <p> Nous n’acceptons pas les cartes de crédit. Mais nous prenons
                les chèques. </p>
            </div>
