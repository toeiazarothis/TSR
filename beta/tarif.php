...
<html lang="fr">
  <head>
    ...
    <link rel="shortcut icon" href="img/PokemonGo.ico">
    <meta property="og:title" content="Pokemon GO envahi Troyes">
    <meta property="og:type" content="website">
    <meta property="og:url" content="Petit site des familles">
    <meta property="og:image" content="http://pogo3.hol.es/img/Objet/superball.png">
          ...
          <div class="col-md-4">
            <div class="panel panel-success">
              ...
              <ul class="list-group list-group-flush text-center">
                ...
                <li class="list-group-item"> Ligne support <span class="fa fa-times pull-right"></span>
                </li>
                <li class="list-group-item"> Cahier de code <span class="fa fa-times pull-right"></span>
                </li>
              </ul>
              <div class="panel-footer"> <button type="button" name="button" class="btn btn-lg btn-block btn-success">Offre
                  1</button> </div>
            </div>
          </div>
          <div class="col-md-4">
