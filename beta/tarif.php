...
<html lang="fr">
  ...
  <body id="page-top" class="index">
    ...
    <section id="tarif">
          ...
          <div class="col-md-3">
            <div class="panel panel-success">
              ...
              <ul class="list-group list-group-flush text-center">
                <li class="list-group-item"> Accès en salle de code <span class="fa fa-check pull-right"></span></li>
              ...
              <div class="panel-footer"><a type="button" class="btn btn-lg btn-block btn-success" data-toggle="modal" data-target=".modal-lg-1" href="#">Détail</a></div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="panel panel-warning">
              <div class="panel-heading">
                <h4 class="text-center">Permis B formation traditionnel</h4>
              </div>
              <div class="panel-body text-center">
              ...
              <div class="panel-footer"><a type="button" class="btn btn-lg btn-block btn-warning" data-toggle="modal" data-target=".modal-lg-2" href="#">Détail</a></div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="panel panel-warning">
              ...
              <div class="panel-footer"> <a type="button" class="btn btn-lg btn-block btn-warning" data-toggle="modal" data-target=".modal-lg-3" href="#">Détail</a>
              </div>
            </div>
          </div>
          <div class="col-md-3">
      ...
      <!--  -->
    <section id="formulaire" class="bg bg-light-gray">
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2 text-center">
            <h2 class="section-heading">Pré-inscription</h2>
            <h3 class="section-subheading text muted">Réaliser une pré-inscription et nous vous rappelons dans les plus bref délais</h3>
            <a href="preinscription.php" class="page-scroll btn btn-xl" type="button" name="button">Se pré-inscrire</a>
          </div>
        </div>
      </div>
    </section>
