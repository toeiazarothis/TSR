      ...
      <div class="row">
        <div class="col-md-3">
          <div class="panel panel-success">
            ...
            <div class="panel-footer"><a type="button" class="btn btn-lg btn-block btn-success" data-toggle="modal" data-target=".modal-lg-1" href="#">Detail</a></div>
          </div>
        </div>
        <div class="col-md-3">
          <div class="panel panel-warning">
            ...
            <div class="panel-footer"><a type="button" class="btn btn-lg btn-block btn-warning" data-toggle="modal" data-target=".modal-lg-2" href="#">Detail</a></div>
          </div>
        </div>
        <div class="col-md-3">
          <div class="panel panel-warning">
            ...
            <div class="panel-footer"> <a type="button" class="btn btn-lg btn-block btn-warning" data-toggle="modal" data-target=".modal-lg-3" href="#">Detail</a> </div>
          </div>
        </div>
        <div class="col-md-3">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4 text-center">
          <h3>Pass-Rousseau</h3>
          <p> Ce pass vous permets d'effectuer des exercices et de suivre des cours depuis votre domicile </p>
        </div>
        <div class="col-md-4 text-center">
          <h3>Suivi perso</h3>
          <p> Afin de maximiser votre réussite l’auto-école sera à votre écoute pour le moindre souci que vous pourriez avoir </p>
        </div>
        <div class="col-md-4 text-center">
          <h3>Un titre</h3>
      ...
      <div class="row">
        <div class="col-md-4 col-xs-12 text-center"> <span><i class="fa fa-circle-o fa-4x"></i></span>
          ...
          <p> Nous organisons des stages de récupération.<br>
            L'erreur est humaine est chaqu'un a le droit d'avoir une nouvelle chance.</p>
        </div>
        <div class="col-md-4 col-xs-12 text-center"> <span><i class="fa fa-car fa-4x"></i></span>
          ...
          <p> La conduite accompagnée à portée de main.<br>
            Il vous suffira de venir accompagne de votre tuteur legal</p>
        </div>
        <div class="col-md-4 col-xs-12 text-center"> <span><i class="fa fa-users fa-4x"></i></span>
          ...
          <p> Venez à 2 c'est mieux. <br>
            1h de conduite offerte au parrain et 1h au filleu. </p>
        </div>
      </div>
    </div>
  </section>
