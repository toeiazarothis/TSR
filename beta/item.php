      ...
      <div class="container">
        <div class="intro-text">
          ...
          <div class="intro-heading">
            <p>Cette page regroupe différente informations sur l'équipement à
              votre disposition</p>
            <a href="#voiture" class="page-scroll btn btn-xl">SUIVRE</a>
          </div>
        </div>
      </div>
    </header>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-8 col-md-offset-2 text-center">
            <h2 class="section-heading">Salle de cours</h2>
