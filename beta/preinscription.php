      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-1 text-center">
          <p>
            <ul class="list-unstyled">
              <li><span class="text-muted"><span class="fa fa-calendar"></span> Sur rendez-vous</span></li>
              <li><span class="text-muted"><span class="fa fa-map-marker"></span> Auto-ecole TSR - 20 Avenue Anatole France - Troyes (10000)</li>
            </ul>
          </p>
        <!-- fin résumé de la prestation -->
        <hr/>
        ...
        <form role="form" id="mail" name="inscription" method="POST" action="choix-paiement.html">
            ...
            <div class="col-xs-12">
              <div class="form-group">
                <label class="radio-inline">
                    <input type="radio" value="Homme" name="civilite" checked /> Monsieur
                </label>
                <label class="radio-inline">
                  <input type="radio" value="Femme" name="civilite" /> Madame
                </label>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-6">
              <div class="form-group">
                ...
                <input name="nom" type="text" id="nom" class="form-control" value="" required/>
              </div>
            </div>
            <div class="col-xs-6">
              <div class="form-group">
                <label for="prenom">Prénom <span style="color:#f00;">*</span> :</label>
                <input name="prenom" type="text" id="prenom" class="form-control"  value="" required/>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-8">
              <!-- date de naissance -->
              <label>Date de naissance <span style="color:#f00;">*</span> : </label>
              <div class="row">
            ...
            <div class="col-md-4">
              <!-- lieu de naissance -->
              <div class="form-group">
                <label for="prenom">Lieu de naissance <span style="color:#f00;">*</span> : </label>
                <input name="lieu_naissance" type="text" id="lieu_naissance" class="form-control" value="" required/>
              </div>
            </div>
          </div>
          <!-- block adresses -->
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                <label for="adresse">Adresse<span style="color:#f00;">*</span> : </label>
                <input name="adresse" type="text" id="adresse" class="form-control" value="" required/>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="codepostal">Code postal <span style="color:#f00;">*</span> : </label>
                <input name="codepostal" type="text" id="codepostal" class="form-control" value="" required/>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="ville">Ville <span style="color:#f00;">*</span> : </label>
                <input name="ville" type="text" id="ville" class="form-control" value="" required/>
              </div>
            </div>
          </div>
          <!-- block contact -->
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                <label for="telephone1">Télephone 1 <span style="color:#f00;">*</span> : </label>
                <input name="telephone1" type="text" id="telephone1" class="form-control" value="" required/>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="telephone2">Télephone 2 : </label>
                <input name="telephone2" type="text" id="telephone2" class="form-control" value="" />
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                <label for="mail">Mail <span style="color:#f00;">*</span> : </label>
                <input name="mail" type="text" id="mail" class="form-control" value="" required/>
              </div>
            </div>
          </div>
          <!-- champs requis -->
